{!! Form::open(['route' => 'items.search', 'method' => 'post']) !!}
                      ...
                      <div class="form-group Genderdiv">
                      	...
                      	<div class="fashionsearch">
                      	<input type="radio" id="womens" name="sex[]" value="W" /><label for="womens" class="Gender">women's</label>
						<input type="radio" id="mens" name="sex[]" value="M" /><label for="mens" class="Gender">men's</label>
					  ...
					  <div class="form-group Scenediv">
					  	<p id="Scene">Scene</p>
					  		...
					  		<div class="fashionsearch2" id="marginbottom15px">
                      	...
                      	<div class="form-group">
		      		 	<p id="pricemarginbottom">
						  <label id="pricemarginbottom" for="amount">Price:</label></p>
						<div id="slider">
						<div id="slider-range"></div>
						</div>
						<div id="pricezone">  
						￥{!! Form::number('minPrice', '0', ['id' => 'minPrice', 'style' => 'border: 0; color: #f6931f; font-weight: bold']) !!}～&emsp;
